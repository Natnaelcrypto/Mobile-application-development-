...
void main() {
  ...
  testWidgets('Emplooye List load test', (WidgetTester tester) async {
    ...
    await tester.enterText(find.byType(TextFormField).at(0), 'naty223');
    await tester.enterText(find.byType(TextFormField).at(1), 'yoh222');
    await tester.enterText(find.byType(TextFormField).at(2), 'nnn223');
    ...
    await tester.tap(
      find.widgetWithText(ElevatedButton, 'Add Emplooye'),
    );
